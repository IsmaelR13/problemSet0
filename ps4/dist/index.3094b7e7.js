...
})({"d5jaN":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "00489c933094b7e7";
"use strict";
...
},{}],"2DqlB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _lodash = require("lodash");
var _lodashDefault = parcelHelpers.interopDefault(_lodash);
var _luxon = require("luxon");
function fetchWithCache(url, options = {}, cacheDuration = 3600000) {
    ...
    if (cachedData) {
        ...
        if (Date.now() - timestamp < cacheDuration) return Promise.resolve(getResponseObject(data)); // Return a promise whose value is the stored data
        else localStorage.removeItem(url);
    }
    // If we don't have cached data or it's expired, fetch it from the network
    return fetch(url, options).then((response)=>response.json()) // Parse the JSON data from the response
    .then((data)=>{
...
//# sourceMappingURL=index.3094b7e7.js.map
